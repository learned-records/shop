package io.sparta.shop.util;

import static io.sparta.shop.service.ProductService.MIN_MY_PRICE;
...
import io.sparta.shop.naver.service.NaverApiService;
import io.sparta.shop.repository.ProductRepository;
import io.sparta.shop.repository.UserRepository;
import io.sparta.shop.service.UserService;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        // 테스트 User 생성
        User testUser = new User("Robbie", passwordEncoder.encode("1234"), "robbie@sparta.com", UserRoleEunm.USER);
